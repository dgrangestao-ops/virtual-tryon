...
const checks=[
 ...
 ["temple tip curves behind ear",g.includes("const tipX=earX-sx*this.imageFrameWidth") && g.includes("const tipY=earY-this.imageFrameHeight") && g.includes("new THREE.Vector3(tipX,tipY,tipZ)")],
